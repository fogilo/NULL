...
public class ClickGui extends GuiScreen {
	...
	public void drawScreen(int x, int y, float p) {
        ...
        this.drawCenteredString(this.fontRendererObj, "N", (halfScreenWidth + 1) - w_c, quarterScreenHeight - 25,
                Utils.Client.rainbowDraw(2L, 1200L));
        this.drawCenteredString(this.fontRendererObj, "U", halfScreenWidth - w_c, quarterScreenHeight - 10,
                Utils.Client.rainbowDraw(2L, 800L));
        this.drawCenteredString(this.fontRendererObj, "L", halfScreenWidth - w_c, quarterScreenHeight + 5,
                Utils.Client.rainbowDraw(2L, 400L));
        this.drawCenteredString(this.fontRendererObj, "L", halfScreenWidth + 1 + w_c, quarterScreenHeight + 20,
