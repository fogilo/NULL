...
public class Raven {
    ...
    public static final String sourceLocation = "https://github.com/fogilo/NULL";
    public static final String downloadLocation = "https://github.com/fogilo/NULL/releases";
    public static final String discord = "https://discord.gg/UqJ8ngteud";
    public static String[] updateText = {
            "Your version of NULL Client (" + versionManager.getClientVersion().toString() + ") is outdated!",
