...
public class Utils {
    ...
    public static class Client {
        ...
        public static int clientColoursDraw(int yOffset, int yTotal) {
            float speed = 6428;
            float hue;
            try {
    ...
    public static class URLS {
        ...
        public static final String base_paste = "{\"description\":\"NULL Client Config\",\"expiration\":\"never\",\"sections\":[{\"name\":\"TitleGoesHere\",\"syntax\":\"text\",\"contents\":\"BodyGoesHere\"}]}";
